...
## [Part 1](https://adventofcode.com/2023/day/10)
...
Result for my input data is: **`6649`** (21ms)

## [Part 2](https://adventofcode.com/2023/day/10#part2)
...
Result for my input data is: **`601`** (23ms)